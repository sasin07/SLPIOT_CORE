                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li>
                                <h4 class="page-title">Add Whether Station</h4>
                            </li>
                        </ul>
                                    ...
                                    <div class="row">
                        				<div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" id="txtCoordinates" readonly="" name="txtCoordinates" class="form-control" placeholder="7°17&apos;26057&quot;N 80°38&apos;1-414&quot;E">
                                                   </div>  
            ...
            function insertData(){
                ...
                $.ajax({
                    ...
                    success:  function(data){
                        swal("Data Inserted", data, "success");
                    },
                ...
                /*if(succ==1){
                     var d=[];
                     var $el=$("#mulpParameterlst");
                     $el.find('option:selected').each(function(){
                         d.push({value:$(this).val(),text:$(this).text()});
                     });
                     var v="{\"p\":"+ JSON.stringify( d ) + "}";
                     //console.log(v);
                     $.ajax({
                        type: "POST",
                        url: "addStation",
